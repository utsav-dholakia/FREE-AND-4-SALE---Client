...
<html>
<head>
<title>Classic Style a Ecommerce Online Shopping Category Flat
			...
			<div class="container">
				<div class="header-left animated wow fadeInLeft"
					...
					<ul>
						...
						<li><i class="glyphicon glyphicon-earphone"></i>+1234 567
							892</li>
						...
						<ul class="nav navbar-nav">
							...
							<!-- <li class="dropdown"><a href="#" class="dropdown-toggle"
								...
								<ul class="dropdown-menu multi multi1">
									<div class="row">
										...
										<div class="col-sm-4">
											<ul class="multi-column-dropdown">
												...
												<li><a href="products1.html">Shoes, Boots &
														Trainers</a></li>
									...
									<div class="row-top">
										<div class="col-sm-6 row1">
											<a href="products1.html"><img src="images/me2.jpg" alt=""
												class="img-responsive"></a>
										</div>
										<div class=" col-sm-6 row2">
											<a href="products1.html"><img src="images/me3.jpg" alt=""
												class="img-responsive"></a>
										</div>
										<div class="clearfix"></div>
									</div>
 ...
 -->
	...
	<div class="content-top">
		<div class="col-md-5 col-md1 animated wow fadeInLeft"
			data-wow-delay=".1s">
			<div class="col-3">
				<a href="single.html"><img src="images/pi1.jpg"
	...
	<div class="footer">
		<div class="container">
			<div class="footer-top">
				<div class="col-md-9 footer-top1">
					...
					<p>Duis aute irure dolor in reprehenderit in voluptate velit
						esse.Excepteur sint occaecat cupidatat non proident Duis aute
			...
			<div class="footer-grids">
				<div class="col-md-4 footer-grid animated wow fadeInLeft"
					data-wow-delay=".5s">
					<h3>About Us</h3>
					<p>
				...
				<div class="col-md-4 footer-grid animated wow fadeInLeft"
					...
					<h3>Contact Info</h3>
					<ul>
						<li><i class="glyphicon glyphicon-map-marker"></i>1234k
							Avenue, 4th block, <span>New York City.</span></li>
						<li class="foot-mid"><i class="glyphicon glyphicon-envelope"></i><a
			...
			<div class="copy-right animated wow fadeInUp" data-wow-delay=".5s">
				<p>
					&copy 2016 Classic Style. All rights reserved | Design by <a
